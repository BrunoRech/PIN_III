...
function createPageCourse() {
    ...
    createCourse('A',
            ...
            'F',
            'G');
    createButton('base', 'b', 'https://www.udemy.com/course/curso-web/');
}

function createCourse(titletx, descrtx, timetx, avaliabletx, certificatetx, valuetx, totaltimetx) {
